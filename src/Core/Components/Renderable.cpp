...
Renderable Renderable::fromSprite(const Position& pos, const std::string& file) {
    ...
    spr.texture = TextureManager::load(file).data;
...
Renderable Renderable::fromMoveAnims(const Position& pos, Movable& movable,
    ...
    mv.data[0] = AnimationManager::load(bl::util::FileUtil::joinPath(path, "up.anim")).data;
    mv.data[1] = AnimationManager::load(bl::util::FileUtil::joinPath(path, "right.anim")).data;
    mv.data[2] = AnimationManager::load(bl::util::FileUtil::joinPath(path, "down.anim")).data;
    mv.data[3] = AnimationManager::load(bl::util::FileUtil::joinPath(path, "left.anim")).data;
...
Renderable Renderable::fromFastMoveAnims(const Position& pos, Movable& movable,
    ...
    mv.walk[0] = AnimationManager::load(bl::util::FileUtil::joinPath(walkPath, "up.anim")).data;
    mv.walk[1] = AnimationManager::load(bl::util::FileUtil::joinPath(walkPath, "right.anim")).data;
    mv.walk[2] = AnimationManager::load(bl::util::FileUtil::joinPath(walkPath, "down.anim")).data;
    mv.walk[3] = AnimationManager::load(bl::util::FileUtil::joinPath(walkPath, "left.anim")).data;

    mv.run[0] = AnimationManager::load(bl::util::FileUtil::joinPath(runPath, "up.anim")).data;
    mv.run[1] = AnimationManager::load(bl::util::FileUtil::joinPath(runPath, "right.anim")).data;
    mv.run[2] = AnimationManager::load(bl::util::FileUtil::joinPath(runPath, "down.anim")).data;
    mv.run[3] = AnimationManager::load(bl::util::FileUtil::joinPath(runPath, "left.anim")).data;
