...
| openStore  | `items`: Array of Integer, `block`: Bool | Void   | Opens the store UI. Takes a list of item ids and prices using their value in the database. Call `pricedItem` to override an item price. |
