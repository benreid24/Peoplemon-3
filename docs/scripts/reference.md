...
| faceEntity       | `spinEnt`: Numeric, `faceEnt`: Numeric                                         | N/A    | Rotates the first entity to face the second entity                                                                   |
| faceDirection    | `spinEnt`: Numeric, `faceEnt`: Numeric                                         | String | Returns the direction the first entity needs to turn to face the second entity                                       |
